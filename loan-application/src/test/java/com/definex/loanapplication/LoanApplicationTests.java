...
import com.definex.loanapplication.test.TestApp;
...
class LoanApplicationTests implements TestApp {
	...
	@Override
	public void login() {
		User user = userRepository.findUserByUserNameAndPassword("Oğuzhan", "asdfg");
		assertEquals("Oğuzhan",user.getUserName());
